...
import { createClasseChatView } from './classes/ClasseChatView.js';
import { createEnseignantsView } from './enseignants/EnseignantsView.js';
import { createEnseignantProfilView } from './enseignants/EnseignantProfilView.js';
...
export const routes = [
  ...
  { path: '/classes', render: createClassesView, requiresAuth: true },
  { path: '/classes/:id', render: createClasseChatView, requiresAuth: true },
  { path: '/enseignants', render: createEnseignantsView },
  { path: '/enseignants/:id', render: createEnseignantProfilView },
