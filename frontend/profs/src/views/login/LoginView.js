...
export const createLoginView = () => {
  ...
  header.append(
    createElement({ tag: 'span', className: 'badge badge-primary', text: 'Connexion enseignant' }),
    createElement({ tag: 'h1', className: 'page-title', text: 'Bon retour' }),
    createElement({ tag: 'p', className: 'page-subtitle', text: 'Accède à ton espace enseignant.' })
  );
  ...
  footer.append(createElement({ tag: 'a', text: 'Créer un compte', attrs: { href: '#/inscription' } }));
